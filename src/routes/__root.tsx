...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SOLESPACE — Premium Men's Footwear" },
      { name: "description", content: "Step into style with SOLESPACE. Premium men's sneakers, loafers, formal shoes, slides and sandals — luxury comfort, modern design." },
      { property: "og:title", content: "SOLESPACE — Premium Men's Footwear" },
      { property: "og:description", content: "Luxury men's footwear. Sneakers, loafers, formal shoes, slides & more." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "SOLESPACE" },
